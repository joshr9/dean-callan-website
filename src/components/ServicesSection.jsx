  ...
  const services = [
    {
      ...
      description: "Collaboration and unity drive our success in every Boulder property management project we undertake together.",
      gradient: "from-brand-500 to-brand-600"
    },
    {
      icon: Shield,
      title: "We Live by Our Word",
      description: "Integrity and reliability form the foundation of our Boulder County client relationships.",
      gradient: "from-green-500 to-green-600"
    },
    {
      icon: Target,
      title: "Whatever It Takes",
      description: "We go above and beyond to ensure your Boulder property management needs are met.",
      gradient: "from-purple-500 to-purple-600"
    },
    {
      icon: Home,
      title: "This Is Our House",
      description: "We treat every Boulder County property with the care and attention we'd give our own.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-4 py-2 bg-white/70 backdrop-blur-sm text-brand-800 rounded-full text-sm font-medium mb-6 shadow-lg">
            ...
            Dean Callan PM - Boulder Property Management Services
          </div>
          
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-800 mb-6">Dean Callan Property Management Values</h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Dean Callan PM's core values guide everything we do, ensuring exceptional service and results for every Boulder County property and tenant we serve.
          </p>
        </div>
